...
class SvmFrame(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.svm_button = ctk.CTkButton(master=self, text='Apply SVM ', font=('Arial', 15), width=400,
                                             height=40,
    ...
    def applySVM(self,ker="rbf",random=None,c=1.0,deg=3,gam="scale",iter=-1):
        ...
        self.controller.frames[mf.ModFrame].model = SVC(kernel=ker,random_state=random,gamma=gam,C=c,max_iter=iter,degree=deg )  # You can change the kernel as needed (linear, rbf, etc.)
        # Train the SVM model
