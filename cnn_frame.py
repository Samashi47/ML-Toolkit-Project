...
class CNNFrame(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.showTrainSplitU_button = ctk.CTkButton(master=self, text='load Resampled Train Data', width=230, height=40,command=lambda:self.controller.frames[ppf.PrePFrame].showDataFrame(self.controller.frames[ppf.PrePFrame].X_train_resampled))
        ...
        self.showTargetTestSplitU_button = ctk.CTkButton(master=self, text='load Resampled Train Target', width=230, height=40,command=lambda:self.controller.frames[ppf.PrePFrame].showDataFrame(self.controller.frames[ppf.PrePFrame].y_train_resampled))
