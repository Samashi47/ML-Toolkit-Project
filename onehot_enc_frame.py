...
class OneHotEncFrame(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.target_label.place(anchor="center",relx=0.40, rely=0.75)
        ...
        self.ohe_button = ctk.CTkButton(master=self, text='Apply One-Hot Encoding', font=('Arial', 15), width=300, height=40,
        ...
        self.ohe_button.place(anchor="center", relx=0.5, rely=0.92)
